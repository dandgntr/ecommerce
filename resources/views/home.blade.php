...
@section('content')
  ...
  <div id="carousel" class="relative flex transition-transform duration-500 ease-out w-full">
    ...
    <div class="w-full flex-shrink-0">
      <img src="{{ asset('image/banner2.png') }}" alt="Slide 1" class="w-full max-w-[1920px] max-h-[672px] object-cover">
    </div>
    <!-- Slide 2 -->
    <div class="w-full flex-shrink-0">
      <img src="{{ asset('image/banner3.png') }}" alt="Slide 2" class="w-full max-w-[1920px] max-h-[672px] object-cover">
    </div>
    <!-- Slide 3 -->
    <div class="w-full flex-shrink-0">
      <img src="{{ asset('image/banner.jpeg') }}" alt="Slide 3" class="w-full max-w-[1920px] max-h-[672px] object-cover">
    </div>
  </div>
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div class="flex justify-center">
        <a href="{{route('detail')}}" class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Quick View</a>
      </div>
    </div>
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img class="object-cover object-center rounded" alt="hero" src="{{ asset('image/Monitor.jpg') }}">
    </div>
  </div>
</section>
    ...
    <div class="flex flex-wrap -m-4">
      <div class="lg:w-1/3 sm:w-1/2 p-4">
        <div class="flex relative">
          <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="{{ asset('image/600 x 360.png') }}">
      ...
      <div class="lg:w-1/3 sm:w-1/2 p-4">
        <div class="flex relative">
          <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="{{ asset('image/601 x 361.png') }}">
          <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
      ...
      <div class="lg:w-1/3 sm:w-1/2 p-4">
        <div class="flex relative">
          <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="{{ asset('image/602 x 362.jpg') }}">
          <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
      ...
      <div class="lg:w-1/3 sm:w-1/2 p-4">
        <div class="flex relative">
          <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="{{ asset('image/603 x 363.jpg') }}">
          <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
      ...
      <div class="lg:w-1/3 sm:w-1/2 p-4">
        <div class="flex relative">
          <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="{{ asset('image/605 x 365.jpg') }}">
          <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
      ...
      <div class="lg:w-1/3 sm:w-1/2 p-4">
        <div class="flex relative">
          <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="{{ asset('image/606 x 366.jpg') }}">
          <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
