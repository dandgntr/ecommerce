  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-4">
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a href="{{ route('detail') }}" class="block relative h-72 rounded overflow-hidden zoom-effect">
          <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ asset('image/MonitorGaming.jpg') }}">
        </a>
        <div class="mt-4">
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-72 rounded overflow-hidden zoom-effect">
          <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ asset('image/Keyboard.png') }}">
        </a>
        <div class="mt-4">
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-72 rounded overflow-hidden zoom-effect">
          <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ asset('image/Mouse.png') }}">
        </a>
        <div class="mt-4">
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-72 rounded overflow-hidden zoom-effect">
          <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ asset('image/Headset.jpg') }}">
        </a>
        <div class="mt-4">
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-72 rounded overflow-hidden zoom-effect">
          <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ asset('image/Mousepad.png') }}">
        </a>
        <div class="mt-4">
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-72 rounded overflow-hidden zoom-effect">
          <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ asset('image/Gamepad.png') }}">
        </a>
        <div class="mt-4">
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-72 rounded overflow-hidden zoom-effect">
          <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ asset('image/Microphone.jpg') }}">
        </a>
        <div class="mt-4">
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-72 rounded overflow-hidden zoom-effect">
          <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ asset('image/GamingChair.png') }}">
        </a>
        <div class="mt-4">
